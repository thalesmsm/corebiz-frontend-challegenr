...
function Footer() {
  return ( 
    <footer className="d-flex justify-content-center text-white p-3" style={{backgroundColor: "black"}}>
      <div className=" footer d-flex justify-content-between" style={{width: 1020}}>
        <div className="localizacao fs-6">
          <h5>Localização</h5>
        ...
        <div className="footer-buttons-div d-flex flex-column align-items-center justify-content-around">
          <button className="footer-buttons-button btn btn-light w-75 h-25 d-flex align-items-center justify-content-between">
            <span className="material-symbols-outlined">
              mail
            </span>
            <span className="text-wrap" style={{fontSize: 10}}>ENTRE EM CONTATO</span>
          </button>
          <button className="footer-buttons-button btn btn-light w-75 h-25 d-flex align-items-center justify-content-around">
            <span className="material-symbols-outlined">
              headset_mic
            </span>
